...
class failureMessages(models.Model):
    ...
    eventlevel = models.ForeignKey("Course" ,on_delete=models.CASCADE)#默认-1刚提交，0驳回，100成功
...
class Course(models.Model):
    courseID = models.IntegerField(u"进程ID")
    coursename = models.CharField(u"进程名称" ,max_length=40)
    isDelete = models.BooleanField(default=False)
