    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wbegin', models.CharField(blank=True, max_length=20, null=True, verbose_name='开始日期')),
                ('wfinish', models.CharField(blank=True, max_length=20, null=True, verbose_name='结束日期')),
